        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                startActivityForResult(new Intent()
                                .setClass(KaiPingActivity.this, KaiPingDetailActivity.class)
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (StringUtil.isNotEmpty(msg)) {
                    Toasts.showShort(KaiPingActivity.this, msg);
                }
            }
        });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_back:
                ...
                break;
            case R.id.iv_right:
                startActivityForResult(new Intent().setClass(KaiPingActivity.this, KaiPingDetailActivity.class), 0);
                break;
        }
    }
